/**
 * run_js_bundle.js — run a DreamPhraseGPT JS bundle exported by DreamPhraseGPT
 *
 * Usage:
 *   node scripts/run_js_bundle.js
 *   node scripts/run_js_bundle.js us_baby_names.model
 *   node scripts/run_js_bundle.js us_baby_names.model --samples 30 --temperature 0.7
 *
...
const CONFIG = Object.freeze({
  modelsDir: path.resolve(repoRoot, "models"),
  defaultSamples: 20,
...
const USAGE_TEXT = [
  "Usage:",
  "  node scripts/run_js_bundle.js [bundle-path] [--samples N] [--temperature FLOAT]",
  "",
  "Examples:",
  "  node scripts/run_js_bundle.js",
  "  node scripts/run_js_bundle.js us_baby_names.model",
